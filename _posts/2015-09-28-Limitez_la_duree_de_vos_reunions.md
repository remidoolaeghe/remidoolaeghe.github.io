...
En réponse à chacun des points de votre **ordre du jour**, forcez-vous à définir un **actionnable** en fin de réunion (si cette notion vous est inconnue, je vous autorise à faire une pauvre pour aller vous cultiver [ici]({% post_url 2015-06-25-Theorie_de_l_actionnable %})). Si votre réunion avait pour seul but d'être informative, alors vous pouvez vous passer de la définition d'un **actionnable**. Dans le cas contraire, vous avez certainement perdu votre temps. Qui plus est, une réunion de deux heures de laquelle ne sort aucun **actionnable** a de fortes chances d'avoir été en grande partie inutile.
