...
![Jaquette de Star Wars, épisode IV]({{ site.images }}/2015-06-23-Un_nouvel_espoir.jpg){: .center-image}

Notre bon vieux développeur a une fascination pour son héros. Celui qui a changé le cours du monde, et dont l'aura ne laisse personne indifférent. <del>[Depressed Darth](https://twitter.com/depresseddarth)</del> *Dark Vador*.

![enter image description here]({{ site.images }}/2015-06-23-Dark_Vador.jpg){: .center-image}
...
![Strangulation de Kendal Ozzel]({{ site.images }}/2015-06-23-Dark_vador_choke.gif){: .center-image}
...
![Construction de l'étoile noire trop lente]({{ site.images }}/2015-06-23-Death_Star_too_slow.gif){: .center-image}
...
![Explosion de l'étoile noire]({{ site.images }}/2015-06-23-Death_Star_Explodes.gif){: .center-image}
...
Le chantier de l'étoile noire est par nature basée sur de la notion de **projet**. La définition référencée par [Wikipédia](http://fr.wikipedia.org/wiki/Projet) est la suivante :
